...
switch(User)
    ...
    case 'Fede'
        dirs.root_raw = 'C:\Users\Fede\Documents\Eperiments\Goss';    % root data for raw acquisitions                                                             % root raw data
        dirs.root_data = 'C:\Users\Fede\Documents\Eperiments\Goss\behavior';  % root data for analysis
        % dirs.root_plot = 'Y:\SW_&_DATA\BIMFERR_MARI\DATA\figures';                                    % root data for images
