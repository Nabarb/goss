...
if strcmp(data.phase,'resting state') % RESTING STATE POTENTIAL
    ...
    xlsData(9:11,1:6) = {'','N-back','% correct','RT mean','RT std', 'Dprime ';...
        ...
        'Sequence 2', data.seq2.back, performance{2}.percCorr, performance{2}.reacTime(1), performance{2}.reacTime(2), performance{2}.dPrime...
        };
