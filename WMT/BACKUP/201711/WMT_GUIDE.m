...
addDigitalChannel(handles.session,'Dev3','Port0/Line0','InputOnly');
    ...
    if get(handles.rs_radiobutton,'value') % RESTING STATE POTENTIAL
        ...
        switch response
            case 'CONFIRM'
                ...
                [handles.seq1.pressTime, seq1Completed] = WMT_displaySequence(handles.seq1.sequence, handles.seq1.stimuli, handles.trialTime, handles.itiTime, handles.session);
                if seq1Completed
                    WMT_displayInstructions('conclusion');
                    ...
                    [handles.seq2.pressTime, seq2Completed] = WMT_displaySequence(handles.seq2.sequence, handles.seq2.stimuli, handles.trialTime, handles.itiTime, handles.session);
                    if seq2Completed
                        WMT_displayInstructions('conclusion');
