...
% Last Modified by GUIDE v2.5 23-Oct-2017 15:47:55
    ...
    if get(handles.rs_radiobutton,'value') % RESTING STATE POTENTIAL
        ...
        switch response
            case 'CONFIRM'
                ...
                [handles.seq1.pressTime, seq1Completed] = WMT_displaySequence(handles.seq1.sequence, handles.trialTime, handles.itiTime);
                if seq1Completed
                    WMT_displayInstructions('conclusion');
                    ...
                    [handles.seq2.pressTime, seq2Completed] = WMT_displaySequence(handles.seq2.sequence, handles.trialTime, handles.itiTime);
                    if seq2Completed
                        WMT_displayInstructions('conclusion');
